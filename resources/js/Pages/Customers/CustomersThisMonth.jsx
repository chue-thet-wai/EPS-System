...
const Index = ({ customers, filters = {} }) => {
    ...
    const { canEdit, canDelete } = checkMenuPermissions('Customers');
    ...
    const handleFilter = useCallback(() => {
        Inertia.get(route('customers.new'), searchFilters, {
            preserveScroll: true,
            preserveState: true,
        });
    }, [searchFilters]);
            ...
            <div className="my-4">
                ...
                <div className="flex">
                    <input
                        type="text"
                        id="search"
                        placeholder={t.pleaseTypeCustomerId}
                ...
                >
                    ...
                    <div className="w-2/3 text-black flex flex-col justify-between pl-2 pt-2 break-words whitespace-normal">
                        <div className="space-y-1 leading-snug">
                            <div>{t.customerId}: {customer.customer_id || ''}</div>
